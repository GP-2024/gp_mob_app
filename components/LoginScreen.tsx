...
const LoginScreen = ({ navigation }) => {
  ...
  const handleLogin = () => {
    ...
    fetch('https://gp-backend-w5ro.onrender.com/auth/local/signin', {
      ...
      .catch(error => {
        Alert.alert("Couldn't connect to the server!", "Make sure there is internet access."); // Show error message in alert
    ...
    <SafeAreaView style={styles.outerContainer} >
      <ScrollView>
        ...
        <View style={styles.sideButtonContainer}>
          <Pressable style={styles.minorButtonPressable}
            onPress={() => console.log("Should redirect to password reset page")}
          >
            <Text style={styles.minorButtonText} >Forgot The Password?</Text>
          </Pressable>
        </View>
