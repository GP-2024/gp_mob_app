...
import { View, Alert, TextInput, TouchableOpacity, StyleSheet, SafeAreaView, ScrollView } from 'react-native';
          ...
          >
            ...
            >
              <Icon
                ...
                color='white'
              />
              <Text h2Style={styles.scanButtonTextStyle} h2>Identify a Plant</Text>
            </View>
          </Button>
        </View>
          ...
          >
            ...
            >
              <Icon
                ...
                color='white'
              />
              <Text h2Style={styles.scanButtonTextStyle} h2>Diagnose a Plant</Text>
            </View>
          </Button>
        </View>
