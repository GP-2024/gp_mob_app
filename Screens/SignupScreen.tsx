...
const SignupScreen = ({ navigation }) => {
    ...
    function handleSignup() {
        ...
        if (termsAgreement === true) {
            ...
            fetch("https://gp-backend-w5ro.onrender.com/auth/local/signup", {
                ...
                .then((data) => {
                    ...
                    if (data.message === "This user already exists") {
                        ...
                        Alert.alert(
                            "",
                            "Please ensure all fields are filled validly before proceeding."
                        );
                    }
            ...
            Alert.alert(
                "",
                "You have to agree to the Terms of Service in order to create an account."
            );
        }
    }
        ...
        <SafeAreaView style={styles.outerContainer}>
            <ScrollView>
                ...
                <View style={styles.secondaryTitleContainer}>
                    <Text style={styles.h4}>Create an account</Text>
                </View>
          ...
          /> */}
                ...
                <View style={styles.agreementContainer}>
                    ...
                    <Pressable
                        ...
                        onPress={() => {
                            console.log(
                                "App expected to be sending user to TOS page."
                            );
                        }}
                    >
                        <Text style={styles.TOSButtonText}>
                            Terms Of Service
                        </Text>
                    </Pressable>
