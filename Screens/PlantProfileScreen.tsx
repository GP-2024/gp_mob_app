...
function extractName(plantDict) {
  ...
  } else if (plantDict.scientific_name && plantDict.scientific_name.length > 0) {
  ...
  useFocusEffect(
    useCallback(() => {
      const fetchPlantDetails = async () => {
        try {
          const plantDetails = await getPlantDetails(plantID, SINGLE_PLANT_ENDPOINT);
          DictionarySmallSummaryForDebugging(plantDetails);
          setPlantDetails(plantDetails);
        } catch (error) {
          console.error('Failed to fetch single plant details:', error);
        }
      };
        ...
        <View>
          ...
          <View style={{
            ...
            <View style={styles.plantTitleContainer}>
              <Text style={styles.h3}>{extractName(plantDetails)}</Text>
            </View>
          </View>
          ...
          <View style={{
            ...
            <PlantCharacteristicsViewer characteristics={extractAvailableCharacteristics(plantDetails)} />
          </View>
